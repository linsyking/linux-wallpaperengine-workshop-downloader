...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = guitest1.0.0
DISTDIR = /home/linsy/文档/Project/guitest/.tmp/guitest1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: guitest.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mytype.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mytype.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mytype.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mytype.cpp
moc_mytype.cpp: mytype.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/linsy/文档/Project/guitest/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/linsy/文档/Project/guitest -I/usr/include/qt -I/usr/include/qt/QtQuick -I/usr/include/qt/QtGui -I/usr/include/qt/QtQmlModels -I/usr/include/qt/QtQml -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/11.1.0 -I/usr/include/c++/11.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/11.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include-fixed -I/usr/include mytype.h -o moc_mytype.cpp
...
main.o: main.cpp mytype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

mytype.o: mytype.cpp mytype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mytype.o mytype.cpp

qrc_qml.o: qrc_qml.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_qml.o qrc_qml.cpp

moc_mytype.o: moc_mytype.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mytype.o moc_mytype.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/guitest/bin || mkdir -p $(INSTALL_ROOT)/opt/guitest/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/guitest/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/guitest/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/guitest/bin/ 
